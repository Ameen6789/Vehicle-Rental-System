...
$dbcon=mysqli_connect('localhost',$user,$pass,"$db");
        $result=mysqli_query($dbcon,"SELECT * from bike");

        if(!$result){
            die('could not connect to mysql server:');
        }
        else{
           echo "<center><h1>Available Bikes</h1></center>";
        ...
        if(isset($_POST['button'])){
            ...
            //   $vdriver=$_POST['driver'];
             ...
             $vedate="";
              ...
              // echo $year;
              $result=mysqli_query($dbcon,"SELECT * from bike where slno='$vslno'");
              $abc=gettype($result);
        //   echo "$abc";
        $ab="";
               $ac=$abc.$ab;
    ...
    //   $vslno1="";
                  ...
                  // echo "2";
                        ...
                        if($vslno1==$vslno)
                        {
                            ...
                            $result3=mysqli_query($dbcon,"SELECT * from bike where slno=$vslno");
                            if(!$result3){
                        // echo "hi";
                                       die('could not connect to mysql server:');
                           }
    ...
    // $aa=$aa+$vamount22;
                        ...
                        /*  echo "<br>";
                          ...
                          $query="INSERT INTO prebike(slno,company,model,number,price,description,status) VALUES('$vslno1','$vcompany1','$vmodel1','$vcarnumber1','$vprice1','$vdescription1','pending')";
...
$vname2="";
  ...
  $query2="INSERT INTO bikerequest(username,name,slno,company,model,number,price,sdate,edate,total) VALUES ('$vid','$vname2','$vslno','$vcompany1','$vmodel1','$vcarnumber1','$vprice1','$vsdate1','$vedate1','$aa')";



                          if(mysqli_query($dbcon,$query2)){

                            $query6="INSERT INTO bikeall(username,name,slno,company,model,number,price,sdate,edate,total,status) VALUES ('$vid','$vname2','$vslno','$vcompany1','$vmodel1','$vcarnumber1','$vprice1','$vsdate1','$vedate1','$aa','approved')";

                            if(mysqli_query($dbcon,$query6)){
                            
                            

                            $query1="INSERT INTO bikeprerequest(username,name,slno,company,model,number,price,sdate,edate,total,status) VALUES ('$vid','$vname2','$vslno','$vcompany1','$vmodel1','$vcarnumber1','$vprice1','$vsdate1','$vedate1','$aa','pending')";
                             
                    
                             if(mysqli_query($dbcon,$query1)){
                              echo "hi";

                            $query="DELETE FROM bike WHERE slno='$vslno'";
