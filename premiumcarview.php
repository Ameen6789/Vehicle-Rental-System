...
<img src="B.jpg" alt="" srcset="" class="abc">
<?php
        ...
        if(isset($_POST['button'])){
            ...
            $ac="";
             ...
             $vedate="";
              ...
              // echo $year;
              $result=mysqli_query($dbcon,"SELECT * from car where not company='toyota' and not company='hyundai' and not company='maruti' and not company='ford' and slno='$vslno'");
              $abc=gettype($result);
        //   echo "$abc";
               $ac=$abc.$ab;
        //   echo "$ac";
        ...
        //   $vslno1="";
            ...
            //   echo "2";
                        ...
                        /*  echo "<br>";
                          ...
                          $result4=mysqli_query($dbcon,"SELECT * from request where carnumber='$vcarnumber1' and username='$vid'");
                          if(!$result4){
                      // echo "hi";
                                     die('could not connect to mysql server:');
                         }
      ...
      $vcarnumber2="";
          ...
          //   echo "2";
                                         while($row=mysqli_fetch_array($result4)){
                                          ...
                                          // echo "$vcarnumber2";
                                          if($vcarnumber2==$vcarnumber1)
                                          {
                                            echo '<script> alert("Request Already Submitted ")</script>';
                                            goto a;
                                          }
                                        }
                          $query="INSERT INTO dupcar(slno,company,model,carnumber,price,seats,description) VALUES('$vslno1','$vcompany1','$vmodel1','$vcarnumber1','$vprice1','$vseats1','$vdescription1')";
                          ...
                          $query="INSERT INTO request(username,name,slno,company,model,carnumber,price,sdate,edate,total) VALUES ('$vid','$vname2','$vslno','$vcompany1','$vmodel1','$vcarnumber1','$vprice1','$vsdate1','$vedate1','$aa')";
                          
                          if(mysqli_query($dbcon,$query)){

                            $query="DELETE FROM car WHERE slno='$vslno1'";
