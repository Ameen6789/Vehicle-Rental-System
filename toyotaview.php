...
<img src="T.jpg" alt="" srcset="" class="abc">
<?php
...
$dbcon=mysqli_connect('localhost',$user,$pass,"$db");
        $result=mysqli_query($dbcon,"SELECT * from car where company='toyota'");
        ...
        if(isset($_POST['button'])){
            ...
            // echo "hi";
             ...
             $vedate="";
              ...
              // echo $year;
              $result=mysqli_query($dbcon,"SELECT * from car where company='toyota' and slno='$vslno'");
              $abc=gettype($result);
        //   echo "$abc";
        $ab="";
               $ac=$abc.$ab;
