...
<nav id="id1" class="topnav">
    ...
    <?php
     ...
     $dbcon=mysqli_connect('localhost',$user,$pass,"$db");
             $result=mysqli_query($dbcon,"SELECT * from signup");
     
             if(!$result){
                 die('could not connect to mysql server:');
             }
             else{
                echo "<center><h1>CUSTOMERS</h1></center>";
             ...
             $result2=mysqli_query($dbcon,"SELECT * from signup where username=$vusername");
             if(!$result2){
    // echo "hi";
                         die('could not connect to mysql server:');
               }
...
//   echo "2";
    ...
    if($vname2==$vusername)
    {
        $query="DELETE FROM SIGNUP WHERE username='$vusername'";
