...
if(!$dbcon){
    ...
    if(isset($_POST['button'])){
     ...
     $car2="";
     $car3="";
    $result=mysqli_query($dbcon,"SELECT * from car where carnumber='$vnumber'");
// echo "$result";
        if(!$result){
            die('could not connect to mysql server:');
        }
          ...
          if($car1==$vnumber)
          {
            echo  '<script> alert("CAR NUMBER ALREADY EXIST")</script>';
            // mysqli_close($dbcon);
            goto a;

          } 
           
    $result1=mysqli_query($dbcon,"SELECT * from request where carnumber='$vnumber'");
    // echo "$result";
            if(!$result1){
                die('could not connect to mysql server:');
            }
              ...
              $result2=mysqli_query($dbcon,"SELECT * from running where carnumber='$vnumber'");
    // echo "$result";
            if(!$result2){
                die('could not connect to mysql server:');
            }
          ...
          if($car3==$vnumber)
          {
            ...
            goto a;
                  ...
                  $query="INSERT INTO car(company,model,carnumber,price,seats,description) VALUES ('$vcompany','$vmodel','$vnumber','$vprice','$vseats','$vdescription')";
...
<nav id="id1" class="topnav">
  ...
  <!-- <div> --><br><li>Company</li>
  <select class="custom-select" style="width:200px;" name="company">
