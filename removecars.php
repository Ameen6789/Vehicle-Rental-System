...
<nav id="id1" class="topnav">
    ...
    <?php
     ...
     $dbcon=mysqli_connect('localhost',$user,$pass,"$db");
             $result=mysqli_query($dbcon,"SELECT * from car");
             ...
             $result2=mysqli_query($dbcon,"SELECT * from CAR where slno=$vusername");
             if(!$result2){
            // echo "hi";
                        //  die('could not connect to mysql server:');
            ...
            //   echo "2";
                ...
                if($vname2==$vusername)
                {
                    $query="DELETE FROM car WHERE slno='$vusername'";
            
                    if(mysqli_query($dbcon,$query)){
                        echo '<script> alert(" REMOVED CAR SUCCESSFULLY")</script>';
                    }
